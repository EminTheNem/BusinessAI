...
if($user_data) {
    // Si déjà connecté, rediriger vers la page ozark_dashboard.html
    ...
    if(!empty($email) && !empty($password)) {
        ...
        if($result && mysqli_num_rows($result) > 0) {
            ...
            if(password_verify($password, $user_data['password'])) {
                ...
                // Rediriger vers ozark_dashboard.html après connexion réussie
                header("Location: ozark_dashboard.php");
                die;
            }
        }
        
        // Si on arrive ici, les identifiants sont invalides
        $error_message = "Email ou mot de passe invalide!";
    } else {
        $error_message = "Veuillez saisir l'email et le mot de passe!";
    }
}
...
<?php endif; ?>
    ...
    <div class="container">
        ...
        <form method="POST" id="auth-form" onsubmit="handleSubmit(event)">
        ...
        <div class="toggle-form">
            Don't have an account? <a href="/TheOfficialBusinessAI_Work/signup.php">Sign up</a>
        </div>
    </div>

    <script>
        function exitToHomepage() {
            window.location.href = "/TheOfficialBusinessAI_Work/index.php";
        }
